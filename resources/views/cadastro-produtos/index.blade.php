...
<div class="container">
    ...
    <div class="mb-3 d-flex justify-content-between align-items-center">
        <a href="{{ route('cadastro-produtos.create') }}" class="btn btn-primary">Cadastrar Novo Produto</a>

        <form action="{{ route('cadastro-produtos.search') }}" method="GET" class="d-flex" style="gap: 10px;">
            ...
            <tbody>
                @foreach($cadastroProdutos as $produto)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('cadastro-produtos.edit', $produto) }}" class="btn btn-warning btn-sm me-1" title="Editar">
                                <i class="fa fa-pen"></i>
                            </a>

                            <form action="{{ route('cadastro-produtos.destroy', $produto) }}" method="POST" style="display:inline;" onsubmit="return confirm('Deseja deletar este produto?')">
                                @csrf
                                @method('DELETE')
